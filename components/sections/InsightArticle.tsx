...
export default function InsightArticle({ post, more }: { post: Post; more: Post[] }) {
  ...
  // Instagram has no web share-intent URL like the others, so copy the link
  // instead — the visitor pastes it into their story or bio.
    ...
    <div className="ucx-article">
      <div className="art-wrapper">
        ...
        <div className="art-share">
          ...
          <button type="button" className="art-share-btn" onClick={copyArticleLink} aria-label="Copy link to share on Instagram">
      ...
      <Toast show={linkCopied} message="Link copied — paste it into your Instagram story or bio." onDismiss={() => setLinkCopied(false)} />
    </div>
  );
}
