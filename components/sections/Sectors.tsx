...
const SECTORS: Card[] = [
  { label: "Commercial", back: "Offices & mixed-use", icon: <Icon d="M4 21V6l8-3 8 3v15M4 21h16M9 9h1M14 9h1M9 13h1M14 13h1M9 21v-5h6v5" /> },
  { label: "Residential", back: "Multi-family & housing", icon: <Icon d="M3 11l9-7 9 7M5 10v10h14V10M10 20v-6h4v6" /> },
  { label: "Mixed-Use", back: "Blended developments", icon: <Icon d="M4 21V9l6-4v4l6-4v16M4 21h16M8 21v-4M14 21v-4" /> },
...
const PARTNERS: Card[] = [
  { label: "Developers", back: "Project sponsors", icon: <Icon d="M4 21V8l8-5 8 5v13M4 21h16M9 21v-6h6v6M9 12h.01M15 12h.01M12 8h.01" /> },
  { label: "Architects", back: "Design leads", icon: <Icon d="M3 21L14 3l7 4-11 18-7-4ZM11 8l5 3M8 13l5 3" /> },
  { label: "Engineers", back: "MEP & structural", icon: <Icon d="M14.7 6.3a4 4 0 01-5.4 5.4L4 17l3 3 5.3-5.3a4 4 0 015.4-5.4l-2.3 2.3-1.5-1.5 2.3-2.3Z" /> },
  { label: "Contractors", back: "Site & delivery teams", icon: <Icon d="M3 8l3-4h12l3 4M3 8v2a2 2 0 002 2h1M3 8h18M21 8v2a2 2 0 01-2 2h-1M6 12v9h12v-9M10 21v-5h4v5" /> },
  { label: "Manufacturers", back: "Prefab & product", icon: <Icon d="M12 2l9 5v10l-9 5-9-5V7l9-5ZM3 7l9 5 9-5M12 12v9" /> },
  { label: "Owners & Operators", back: "Long-term asset value", icon: <Icon d="M12 3l2.6 5.6L21 9.3l-4.5 4.2 1.2 6-5.7-3.1L6.3 19.5l1.2-6L3 9.3l6.4-.7Z" /> },
];
