    ...
    cols: [
      {
        ...
        links: [
          { href: "/bim-digital-delivery#service-1", label: "BIM & VDC" },
          { href: "/bim-digital-delivery#service-2", label: "Digital Engineering" },
          { href: "/bim-digital-delivery#service-3", label: "BIM Coordination" },
          { href: "/bim-digital-delivery#service-4", label: "Digital Construction" },
          { href: "/bim-digital-delivery#service-5", label: "Automation & 4D/5D" },
        ],
      ...
      },
      {
        ...
        links: [
          { href: "/project-construction-support#service-1", label: "Project Documentation" },
          { href: "/project-construction-support#service-2", label: "Project Controls" },
          { href: "/project-construction-support#service-3", label: "Quantity & Data" },
          { href: "/project-construction-support#service-4", label: "QA/QC" },
          { href: "/project-construction-support#service-5", label: "Execution Support" },
        ],
      ...
      },
      {
        ...
        links: [
          { href: "/asset-digital-information#service-1", label: "As-Built BIM" },
          { href: "/asset-digital-information#service-2", label: "Asset Information" },
          { href: "/asset-digital-information#service-3", label: "COBie & Data" },
          { href: "/asset-digital-information#service-4", label: "FM Models" },
          { href: "/asset-digital-information#service-5", label: "Digital Handover & Twin" },
        ],
    ...
    cols: [
      {
        ...
        links: [
          { href: "/projects?filter=commercial", label: "Commercial & Mixed-Use" },
          { href: "/projects?filter=residential", label: "Residential" },
          { href: "/projects?filter=industrial", label: "Industrial" },
          { href: "/projects?filter=infrastructure", label: "Infrastructure" },
          { href: "/projects?filter=specialized", label: "Specialized Projects" },
        ],
        ctaHref: "/projects",
      ...
      },
      {
        ...
        theme: "interiors",
        links: [
          { href: "/projects?filter=interiors&cat=workplace-office", label: "Workplace & Office" },
          { href: "/projects?filter=interiors&cat=hospitality-retail", label: "Hospitality & Retail" },
          { href: "/projects?filter=interiors&cat=residential-interiors", label: "Residential Interiors" },
          { href: "/projects?filter=interiors&cat=custom-furniture", label: "Custom Furniture" },
          { href: "/projects?filter=interiors&cat=modular-interiors", label: "Modular Interiors" },
        ],
      ...
      },
      {
        ...
        links: [
          { href: "/digital-project-experience?filter=bim-vdc", label: "BIM & VDC" },
          { href: "/digital-project-experience?filter=scan-to-bim", label: "Scan-to-BIM" },
          { href: "/digital-project-experience?filter=as-built-bim", label: "As-Built BIM" },
          { href: "/digital-project-experience?filter=digital-engineering", label: "Digital Engineering" },
          { href: "/digital-project-experience?filter=prefabrication", label: "Prefabrication" },
        ],
    ...
    cols: [
      {
        ...
        links: [
          { href: "/collaboration-lab#overview", label: "About the Lab" },
          { href: "/collaboration-lab#how-it-works", label: "How It Works" },
          { href: "/collaboration-lab#ways-to-collaborate", label: "Collaboration Process" },
    ...
    cols: [
      {
        ...
        links: [
          ...
          { href: "/blogs?category=bim-digital", label: "BIM & Digital" },
          { href: "/blogs?category=design-delivery", label: "Design & Interiors" },
          { href: "/blogs?category=technology-ai", label: "Technology & AI" },
        ],
        ctaHref: "/blogs",
      ...
      },
      {
        ...
        links: [
          ...
          { href: "/case-studies", label: "Project Lessons" },
          { href: "/case-studies", label: "Delivery Insights" },
        ],
      ...
      },
      {
        ...
        links: [
          { href: "/resources?category=guides", label: "Guides" },
          { href: "/resources?category=templates", label: "Templates" },
          { href: "/resources?category=reports", label: "Reports" },
        ],
        ctaHref: "/resources",
    ...
    cols: [
      {
        ...
        links: [
          ...
          { href: "/about-us#workspace", label: "Our Workspace" },
        ],
        ctaHref: "/about-us",
...
const MOBILE_ITEMS: MobileItem[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/case-studies", label: "Project Knowledge" },
